...
public class TestProjectService : ITestProjectService
{
    ...
    string TestProjectPath = string.Empty;
    ...
    {
        var filePath = GetFilePath(TestProjectPath, "AppShell.xaml");
    ...
    {
        var filePath = GetFilePath(TestProjectPath, "MainPage.xaml.cs");
    ...
    {
        var filePath = GetFilePath(TestProjectPath, "MainPage.xaml");
    ...
    string GetFilePath(string? csprojPath, string fileName)
    {
